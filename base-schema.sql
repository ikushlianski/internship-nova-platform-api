...
CREATE SCHEMA public AUTHORIZATION ikushlianski;
...
CREATE TABLE public.mentors (
	...
	class_id varchar NOT NULL,
	CONSTRAINT mentors_classes_fk FOREIGN KEY (class_id) REFERENCES public.classes(class_id),
	CONSTRAINT mentors_users_fk FOREIGN KEY (user_id) REFERENCES public.users(user_id)
);
